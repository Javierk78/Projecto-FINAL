		...
		<div className='flex flex-col h-screen'>
			...
			<main className='container flex-1 flex flex-col items-center gap-10'>
				...
				<div className='border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3'>
					...
					<p className='text-sm'>
						Gracias por realizar tu compra en Aliaga Motors. Para
						realizar el pago te compartimos los siguientes
						datos
					</p>

					<div className='space-y-0.5 text-sm'>
						<p>Compra a traves de BIZUM</p>
						<p>ALIAGA MOTORS</p>
						<p>Concepto: Numero de Pedido</p>
						<p>Número de telefono para pago: 644337110</p>
						<p>La información será compartida nuevamente una vez que se haya finalizado la compra</p>
					</div>

					<p className='text-sm'>
						Una vez realizado el pago, comparte tu
						comprobante a aliagamotors@gmail.com para procesarla
				...
				<div className='border border-slate-200 w-full p-5 rounded-md space-y-3 md:w-[600px]'>
					...
					<div className='grid grid-cols-2 gap-5'>
						...
						<div className='flex flex-col text-sm'>
							...
							<p>
								Pago por BIZUM - {formatPrice(data.totalAmount)}
							</p>
						</div>
