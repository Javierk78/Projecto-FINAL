...
// Función para formatear el precio a Euros
export const formatPrice = (price: number) => {
	return new Intl.NumberFormat('es-ES', {
		style: 'currency',
		currency: 'EUR',  // Cambié 'USD' por 'EUR' para mostrar el precio en Euros
...
// Función para formatear la fecha a formato X de enero de 20XX
