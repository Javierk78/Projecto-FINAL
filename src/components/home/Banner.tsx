	...
	return (
		<div className='relative bg-gray-900 text-white'>
			...
			<div
				...
				style={{ backgroundImage: 'url(/img/background-newsletter1.webp)' }}
			/>
			...
			<div className='relative z-10 flex flex-col items-center justify-center py-20 px-4 text-center lg:py-40 lg:px-8'>
				<h1 className='text-4xl font-bold mb-4 lg:text-6xl'>
					Encuentra nuestros mejores productos 
				</h1>
				...
				<Link
					to='/tiendas'
					className='bg-black hover:bg-gray-950 text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition duration-300 ease-in-out'
				>
					Ver productos
				</Link>
			</div>
