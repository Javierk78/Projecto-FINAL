...
export const Footer = () => {
	return (
		<footer className='py-16 bg-black px-12 flex justify-between gap-10 text-slate-200 text-sm flex-wrap mt-10 md:flex-nowrap'>
			<Link
  to='/'
  className='text-2xl font-bold tracking-tighter transition-all text-white flex-1'
>
  <span className='text-white'>Aliaga</span> <span className='text-red-500'>Motors</span>
</Link>
			...
			<div className='flex flex-col gap-4 flex-1'>
				...
				<nav className='flex flex-col gap-2 text-xs font-medium'>
					<Link to='/tiendas'>Productos</Link>
			...
			<div className='flex flex-col gap-4 flex-1'>
				...
				<p className='text-xs leading-6'>
					Para ser el primero en enterarte de todas las novedades
				</p>
